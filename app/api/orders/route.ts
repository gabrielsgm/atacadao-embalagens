...
export async function POST(req: NextRequest) {
  ...
  // Only check profile completeness for clients (not admins placing orders)
      ...
      return NextResponse.json(
        {
          ...
          description: `Complete seu perfil antes de realizar pedidos. Campos faltando: ${missing.join(", ")}.`,
